...
parser.add_argument(
    "--pretrained_model",
    default=os.path.join(caffe_root, "models/VGGNet/VOC0712/SSD_300x300/VGG_VOC0712_SSD_300x300_iter_120000.caffemodel"),
    help="Trained model weights file."
)
parser.add_argument(
    "--label_map_file",
    default=os.path.join(caffe_root, "data/VOC0712/labelmap_voc.prototxt"),
...
visualize_threshold = args.threshold
# Size of video image.
video_width = 1280
video_height = 720
...
save_dir = os.path.join(caffe_root, "models/VGGNet/VOC0712/{}_video".format(job_name))
# Directory which stores the snapshot of trained models.
snapshot_dir = os.path.join(caffe_root, "models/VGGNet/VOC0712/{}".format(job_name))
# Directory which stores the job script and log file.
job_dir = os.path.join(caffe_root, "jobs/VGGNet/VOC0712/{}_video".format(job_name))

# model definition files.
test_net_file = "{}/test.prototxt".format(save_dir)
#test_net_file = args.model_def
# snapshot prefix.
...
check_if_exist(args.pretrained_model)
